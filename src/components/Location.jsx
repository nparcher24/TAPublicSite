...
export function Location(props) {
  ...
  return (
    <div className="w-screen my-10 bg-green-300 relative">
      <div className="max-w-md md:absolute md:m-10 md:mt-20 max-h-56 md:max-h-80 p-2 md:py-5 md:rounded-lg bg-white border-t-2 md:border-2 md:z-10 overflow-y-auto border-taLightRed">
      ...
      <div style={{ height: "80vh", width: "100%" }}>
        ...
        >
          {locations.map((location) => {
            return (
              <button
                className="focus:border-taRed w-auto h-auto"
                id={location.name}
              ...
              >
                {location.name === isOpened ? (
                  <div
                    className="bg-white p-4 rounded-lg flex-col space-y-4"
                    style={{ width: "200px" }}
                  >
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <a
                        href={location.link}
                        className="py-2 px-4 bg-taBlue text-white font-body rounded-lg "
                      >
                        GET DIRECTIONS
                      </a>
                    </div>
