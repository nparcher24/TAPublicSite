...
export default function Terms() {
  return (
    <div>
      <div className="pt-24 px-4 md:px-24 space-y-4">
        <div class="tab-content translations-content-item en visible" id="en">
          <h1 className="font-heading text-4xl py-4">Terms and Conditions</h1>
          <p className="font-body ">Last updated: October 19, 2021</p>
          <p className="font-body ">
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <h1 className="font-heading text-4xl py-4">
            Interpretation and Definitions
          </h1>
          <h2 className="py-4 text-2xl font-heading">Interpretation</h2>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Definitions</h2>
          <p className="font-body ">
            For the purposes of these Terms and Conditions:
          </p>
          <ul className="list-disc font-body pl-10">
            <li>
              <p className="font-body ">
            ...
            <li>
              <p className="font-body ">
                ...
                in this Agreement) refers to Battle Bars HQ, LLC, 21020 N Rand
                Road, Suite B, Deer Park, IL 60047.
              </p>
            </li>
            <li>
              <p className="font-body ">
            ...
            <li>
              <p className="font-body ">
                <strong>Website</strong> refers to 10.40.10 Fitness, accessible
                from
                <a
                  href="https://104010fitness.com"
                  rel="external nofollow noopener"
                >
                  https://104010fitness.com
                </a>
              </p>
            </li>
            <li>
          ...
          <h1 className="font-heading text-4xl py-4">Acknowledgment</h1>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Your Information</h2>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Order Cancellation</h2>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">
          ...
          <h2 className="py-4 text-2xl font-heading">Prices Policy</h2>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Payments</h2>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">User Accounts</h1>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Content</h1>
          <h2 className="py-4 text-2xl font-heading">
          ...
          <h2 className="py-4 text-2xl font-heading">Content Restrictions</h2>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Content Backups</h2>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Copyright Policy</h1>
          <h2 className="py-4 text-2xl font-heading">
          ...
          <p className="font-body ">
            ...
            <a className="text-blue-800" href="mailto:info@104010fitness.com">
              {" "}
          ...
          <h1 className="font-heading text-4xl py-4">Intellectual Property</h1>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Your Feedback to Us</h1>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Termination</h1>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Governing Law</h1>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Disputes Resolution</h1>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Severability</h2>
          <p className="font-body ">
          ...
          <h2 className="py-4 text-2xl font-heading">Waiver</h2>
          <p className="font-body ">
          ...
          <h1 className="font-heading text-4xl py-4">Contact Us</h1>
          <p className="font-body ">
          ...
          <ul className="list-disc font-body pl-10">
            <li>
              <p className="font-body ">
                ...
                <a
                  ...
                  href="mailto:info@104010fitness.com"
                >
                  {" "}
                  Info@104010fitness.com{" "}
                </a>
            ...
            <li>
              <p className="font-body ">By phone number: 847.481.6038</p>
            </li>
          </ul>
        </div>
      </div>
